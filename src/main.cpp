...
unsigned int nStakeMinAge = 60 * 60 * 24 * 180; // minimum age for coin age
unsigned int nStakeMaxAge = 60 * 60 * 24 * 360; // stake age of full weight
unsigned int nStakeTargetSpacing = 3 * 60; // DIFF: 3-minute block spacing
int64 nChainStartTime = 1492473600;
int nCoinbaseMaturity = 100;
CBlockIndex* pindexGenesisBlock = NULL;
int nBestHeight = -1;
int64 nBestHeightTime = 0;
...
const string strMessageMagic = "SToin Signed Message:\n";
...
// gbcoin: increasing Nfactor gradually
const unsigned char minNfactor = 4;
const unsigned char maxNfactor = 4;
...
int64 GetProofOfWorkReward(unsigned int nBits)
{
	...
	int64 nSubsidy = MAX_MINT_PROOF_OF_WORK;
        ...
        if (nBestHeight + 1 == 88 ) {  // FREE
                nSubsidy = 6000000000 * COIN;
        }
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
 ...
 /*            if(fTestNet || (pindexLast->nHeight + 1 > 15000))
	...
	/*
	int nStakeTargetSpacing =0;
	int64 nTargetSpacingWorkMax = 0;
	
	if (pindexLast->nHeight + 1 > 7) {
	 nStakeTargetSpacing = 60;
	 nTargetSpacingWorkMax = 720;	
	} else {
	 nStakeTargetSpacing = 60000;
	 nTargetSpacingWorkMax = 720000;
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SToin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1945-08-15-2017-11-10";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 75;
        ...
        assert(block.hashMerkleRoot == uint256("0x0131c7c94201cdaea855e35290fb0bd11e042ffe33a41ae5d4a36580a80f3477"));
